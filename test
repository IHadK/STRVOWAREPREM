...
strvo.bg.pre.Text = '<font color="#FFFFF2">strvoware - Version 2.4</font>'
...
local playertab = library:addTab("target")

local playertab = playertab:createGroup('left', "strvoware- targethub")

local playertab = playertab:addButton({text = "loader", callback = function()
